...
{
    /// <summary>
    /// Specifies a range between a minimum and a maximum <see cref="Int64"/> value.
    /// </summary>
    public sealed class Int64Range : ImmutableRange<long>
    {
        #region Construction
        /// <summary>
        /// Creates a new <see cref="Int64Range"/> object.
        /// </summary>
        /// <param name="minimum">The minimum value of the range.</param>
        /// <param name="maximum">The maximum value of the range.</param>
        public Int64Range(long minimum, long maximum)
        ...
        /// </summary>
        /// <param name="minimum">The minimum value of the range.</param>
        public Int64Range(long minimum)
            : this(minimum, Int64.MaxValue) {
        }
        ...
        public override bool IsInRange(long value, bool isMinimumIncluded = true, bool isMaximumIncluded = true) {
            var isInRange =
